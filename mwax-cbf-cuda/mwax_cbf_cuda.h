...
int mwax_discard_oversampled_spectral_portions(float complex* input, float complex* output, int paths, int num_input_channels, int num_output_channels, int num_ffts, cudaStream_t stream);
